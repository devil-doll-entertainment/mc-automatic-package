...
If you find a security vulnerability in **MC-AutomaticPackage**, report it privately before disclosing it publicly.

**Preferred channel:**
Email — `legal.sxnnyside@sxnnysideproject.com`

**Alternative:**
[GitHub Private Security Advisory](https://github.com/devil-doll-entertainment/mc-automatic-package/security/advisories/new)
...
This policy covers the **MC-AutomaticPackage** repository only.
